...
%-------------------------------------------------------------------------------------------------------------------------------------%
projectName = 'HIV_Scott'; %spelled the exact same as the folder it is in
...
experimentDates = {'08_15_2014'}; %dates of experiments, each one is a directory where GPR files are saved.
expPrefix    = {'HIV_08_15_14_'}; % all slides and slideToSampleMapping file for each date have the exact same filePrefix
...
processGPRfunctionHandle = @processHIV_Scott_GPRstruct_Multiplex; % < > needs to be updated for specific project
