...
experimentDates = {'08_28_2014'}; %dates of experiments, each one is a directory where GPR files are saved.
expPrefix    = {'dengue_zm_08_28_14_'}; % all slides and slideToSampleMapping file for each date have the exact same filePrefix
...
processGPRfunctionHandle = @processDENGUE_2014_GPRstruct_Multiplex; 
