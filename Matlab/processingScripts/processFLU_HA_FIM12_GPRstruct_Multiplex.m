...
function [seqGPRstruct,otherGPRstruct] = processFLU_HA_FIM12_GPRstruct_Multiplex(gprStruct,arrayNumber,numArrays)
...
pathogenNames = {'Cal_HA', 'Cal_NA', 'Vic_HA', 'Vic_NA', 'Wis_HA', 'Wis_NA'};% names of strain in array, add other names only if placed on the same gal file,
