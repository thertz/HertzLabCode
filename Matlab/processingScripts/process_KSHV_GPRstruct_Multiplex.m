...
function [seqGPRstruct,otherGPRstruct] = process_KSHV_GPRstruct_Multiplex(gprStruct,arrayNumber,numArrays)
...
pathogenNames = {'K'};% names of strain in array, add other names only if placed on the same gal file,
