...
%
% for Dengue humans monoclonals from the Harris Lab - updated to work on new data generated on in-house printed slides Dec. 2014
...
% noe recompute indices of neg controls after removing all mouse/mAb data:
