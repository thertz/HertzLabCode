...
function [pValuesRankSum,pValuesFisher,group1responseHigher,fisherCounts] = compareGroupsByAntigen(respMat,labels,posThreshold)

% Compute two-sided ranksum pValues for specific antigens which are uncorrected. We then use filters to limit our
