...
function [seqGPRstruct,otherGPRstruct] = processFLU_H7N9_GPRstruct_Multiplex(gprStruct,arrayNumber,numArrays)
...
pathogenNames = {'Cal_HA','Vie_HA','Cal_NA','Vie_NA','McGarg'};% names of strain in array, add other names only if placed on the same gal file,
