...
experimentDates = {'08_21_2014','08_22_2014','08_25_2014','09_04_2014', '09_05_2014'}; %dates of experiments, each one is a directory where GPR files are saved.
expPrefix    = {'H7N9_08_21_14_','H7N9_08_22_14_','H7N9_08_25_14_','H7N9_09_04_14_', 'H7N9_09_05_14_'}; % all slides and slideToSampleMapping file for each date have the exact same filePrefix
...
processGPRfunctionHandle = @processFLU_H7N9_GPRstruct_Multiplex; 

%-------------------------------------------------------------------------------%

for i=4:length(experimentDates)%highlighted by zwm 07112014 i=4:4%length(experimentDates)
