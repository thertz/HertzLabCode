...
experimentDates = {'<Date 1>,<Date 2>'}; %dates of experiments, each one is a directory where GPR files are saved.
expPrefix    = {'<prefix for date 1>','<prefix for date 2>'}; % all slides and slideToSampleMapping file for each date have the exact same filePrefix
...
figInd = 1;
for i=3:length(experimentDates)
