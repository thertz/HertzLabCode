...
experimentDates = {'03_10_2015','03_12_2015'};  %dates of experiments, each one is a directory where GPR files are saved.
expPrefix    = {'McGargill_03_10_15_','McGargill_03_12_15_'}; % all slides and slideToSampleMapping file for each date have the exact same filePrefix
...
processGPRfunctionHandle = @processMcGargill_inhouse_GPRstruct_Multiplex; 
