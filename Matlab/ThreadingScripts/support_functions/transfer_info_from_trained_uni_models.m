function [Modified_Candidates,num,minm]=transfer_info_from_trained_uni_models(str,exp_binding_energies,num); 
...
%B_type={'gl_B_lin_reg','gl_B_linp_reg','B_linp_reg_linp_reg','B_linp_reg_lin_reg'};
B_type={'gl_B_linp_reg','B_linp_reg_linp_reg'};
Pair_mtrx = {'miy','bet'};
