function [PSSMs]=get_ext_PSSM_for_str(input_strs,model,cross_set,iter_h,iter)
...
[num_input_HLAs,pos_len] = size(input_strs);

if pos_len < max_pos_len
    error(['Input aa sequences should be at least ' num2str(max_pos_len) ' aminoacids long;'])
end

input_strs = input_strs(:,1:max_pos_len);
