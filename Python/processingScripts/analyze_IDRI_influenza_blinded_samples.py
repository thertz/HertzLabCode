...
SAVE_PATH = ROOT_PATH + 'ArrayData/Influenza/IDRI/'
FIG_PATH = ROOT_PATH + 'ArrayData/Influenza/IDRI/Figs/'
...
time_point_postfixes = ['_d0', '_d21', '_d42']
...
arr_summary_stats = ['H5_mag', 'N1_mag']#, 'H1_mag', 'N1_mag']
...
arr_df = None
for fni, fileName in enumerate(glob.glob(ROOT_PATH + '/ArrayData/Influenza/IDRI/*/*.mat')):
    print(fni, fileName)
